...
class Farm_I extends \FarmBundle\Entity\Farm_I implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addSpecy(\FarmBundle\Entity\Species $species)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSpecy', [$species]);

        return parent::addSpecy($species);
    }
    ...
    public function removeSpecy(\FarmBundle\Entity\Species $species)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSpecy', [$species]);

        return parent::removeSpecy($species);
    }
