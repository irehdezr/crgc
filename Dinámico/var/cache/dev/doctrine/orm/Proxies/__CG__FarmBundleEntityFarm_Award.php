 ...
 */
class Farm_Award extends \FarmBundle\Entity\Farm_Award implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FarmBundle\\Entity\\Farm_Award' . "\0" . 'farm', '' . "\0" . 'FarmBundle\\Entity\\Farm_Award' . "\0" . 'award', '' . "\0" . 'FarmBundle\\Entity\\Farm_Award' . "\0" . 'place', '' . "\0" . 'FarmBundle\\Entity\\Farm_Award' . "\0" . 'year'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Farm_Award $proxy) {
