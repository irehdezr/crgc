...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HdjzSD8ar2', 0, 'eFI4IKn03qKMRAJ+Eersxf', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\PageBundle\\Resources\\config\\doctrine') => 'PageBundle\\Entity', ($this->targetDirs[3].'\\src\\FarmBundle\\Resources\\config\\doctrine') => 'FarmBundle\\Entity', ($this->targetDirs[3].'\\src\\ProductBundle\\Resources\\config\\doctrine') => 'ProductBundle\\Entity', ($this->targetDirs[3].'\\src\\UserBundle\\Resources\\config\\doctrine') => 'UserBundle\\Entity'));
        ...
        $c->setEntityNamespaces(array('PageBundle' => 'PageBundle\\Entity', 'FarmBundle' => 'FarmBundle\\Entity', 'ProductBundle' => 'ProductBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('zqOGi2fRBy', NULL, 'eFI4IKn03qKMRAJ+Eersxf', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+ElHr+VsRo', 0, 'eFI4IKn03qKMRAJ+Eersxf', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59089c455550a3.03102002')), true);
