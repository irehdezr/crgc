 ...
 */
class Award extends \FarmBundle\Entity\Award implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FarmBundle\\Entity\\Award' . "\0" . 'id', '' . "\0" . 'FarmBundle\\Entity\\Award' . "\0" . 'farm_awards', '' . "\0" . 'FarmBundle\\Entity\\Award' . "\0" . 'description'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Award $proxy) {
