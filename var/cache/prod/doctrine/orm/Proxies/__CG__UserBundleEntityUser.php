...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'addresses', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'shoppingCart'];
        }
    ...
    public function addShoppingCart(\ProductBundle\Entity\Presentation $shoppingCart)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addShoppingCart', [$shoppingCart]);

        return parent::addShoppingCart($shoppingCart);
    }
    ...
    public function removeShoppingCart(\ProductBundle\Entity\Presentation $shoppingCart)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeShoppingCart', [$shoppingCart]);

        return parent::removeShoppingCart($shoppingCart);
    }
