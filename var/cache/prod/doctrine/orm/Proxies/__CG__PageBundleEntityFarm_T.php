...
class Farm_T extends \PageBundle\Entity\Farm_T implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'id', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'pageTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'descriptionTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'storyBtnTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'informationTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'awardsTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'locationTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'productsTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'regionTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'elevationTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'harvestTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'speciesTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'speciesInfo', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'cultivarTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'certificationsTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'orderTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'moreInfoTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'reviewsTitle', '' . "\0" . 'PageBundle\\Entity\\Farm_T' . "\0" . 'contactBtnTitle'];
        }
    ...
    public function setStoryBtnTitle($storyBtnTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStoryBtnTitle', [$storyBtnTitle]);

        return parent::setStoryBtnTitle($storyBtnTitle);
    }
    ...
    public function getStoryBtnTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStoryBtnTitle', []);

        return parent::getStoryBtnTitle();
    }
    ...
    public function setRegionTitle($regionTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRegionTitle', [$regionTitle]);

        return parent::setRegionTitle($regionTitle);
    }
    ...
    public function getRegionTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRegionTitle', []);

        return parent::getRegionTitle();
    }
    ...
    public function setMoreInfoTitle($moreInfoTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMoreInfoTitle', [$moreInfoTitle]);

        return parent::setMoreInfoTitle($moreInfoTitle);
    }
    ...
    public function getMoreInfoTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMoreInfoTitle', []);

        return parent::getMoreInfoTitle();
    }
    ...
    public function setContactBtnTitle($contactBtnTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContactBtnTitle', [$contactBtnTitle]);

        return parent::setContactBtnTitle($contactBtnTitle);
    }
    ...
    public function getContactBtnTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContactBtnTitle', []);

        return parent::getContactBtnTitle();
    }
